...
<head>
  ...
  <title>Fatecshop - Cadastrar Usuário</title>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <form action="usuario_action.php" method="POST" autocomplete="off">
                    <div class="mb-3">
                        <label>Nome</label>
                    ...
                    <div class="mb-3">
                        <label>Senha</label>
                        <input type="password" name="senha" class="form-content" placeholder="********" required>
                    </div>
                    <div class="mb-3">
                      <input type="submit" name="create_user" class="btn btn-primary" value="Salvar">
                    </div>
                </form>
              </div>
            </div>
